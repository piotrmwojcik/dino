...
def get_args_parser():
    ...
    parser.add_argument('--image_size', type=float, nargs=int, default=224,
    ...
    parser.add_argument("--local-rank", default=0, type=int, help="Please ignore and do not set this argument.")  # alias, same dest
    return parser
